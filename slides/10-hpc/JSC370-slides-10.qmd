...
subtitle: "Week 10: High Performance Computing"
format:
  revealjs:
    transition: slide
    slide-number: true
...
![Here we are using a single core. The function is applied one element at a time, leaving the other 3 cores without usage.](img/pll-computing-explained-serial.svg){fig-align="center" width="30%"}
