...
|-----|--------------|-----------------|---------|
| **Week 1** | January 5 [(lecture)](slides/01-introduction/JSC370-slides-01.html) <br> January 7 ([lab](labs/JSC370-labs-01.html)) not in person this week only! | Introduction to Data Science tools: Python, Quarto, VS Code | **Lab 1** |
