...
| **Week 3** | January 19 [(lecture)](slides/03-eda-viz/JSC370-slides-03.html) <br> January 21 (lab) | Exploratory Data Analysis & Data Viz 1| **Lab 3** |
| **Week 4** | January 26 (lecture) <br> January 28 (lab) | Data Viz 2 & ML 1 (kernel and gam regression) | **[HW1](homework/hw1_2026.pdf)**, **Lab 4** |
| **Week 5** | February 2 (lecture) <br> February 4 (lab) | Regular expressions; data scraping; using APIs | **Lab 5** |
| **Week 6** | February 9 (lecture) <br> February 11 (lab) | Text mining, LLMs | **HW2**, **Lab 6** |
| **Week 7** | February 16 | Reading Week |  |
| **Week 8** | February 23 (lecture) <br> February 25 (lab) | ML 2 (trees, random forests, boosting) | **Lab 8** |
| **Week 9** | March 2 (lecture) <br> March 4 (lab) | ML 3 (model evaluation and interpretation) | **HW3**, **Lab 9** |
| **Week 10** | March 9 (lecture) <br> March 11 (lab) | SQL, High performance computing; cloud computing | **Midterm**, **Lab 10** |
