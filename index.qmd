...
|-----|--------------|-----------------|---------|
| **Week 1** | January 5 [(lecture)](slides/01-introduction/JSC370-slides-01.qmd) <br> January 7 ([lab](labs/JSC370-lab-01.html)) not in person this week only! | Introduction to Data Science tools: Python, Quarto, VS Code | **Lab 1** |
| **Week 2** | January 12 [(lecture)](slides/02-version-control/JSC370-slides-02.html) <br> January 14 (lab) | Version Control & Reproducible Research, Git/GitHub | **Lab 2** |
...
| **Week 9** | March 2 (lecture) <br> March 4 (lab) | SQL, High performance computing; cloud computing | **HW3**, **Lab 9** |
| **Week 10** | March 9 (lecture) <br> March 11 (lab) | ML 2 (trees, random forests, boosting) | **Midterm**, **Lab 10** |
| **Week 11** | March 16 (lecture) <br> March 18 (lab) | Interactive visualization & effective data communication | **Lab 11** |
| **Week 12** | March 23 (lecture) <br> March 25 (lab) | Building Website and Interactive Apps | **HW4**, **Lab 12** |
