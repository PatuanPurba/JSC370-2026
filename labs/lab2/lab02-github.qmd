...
- Create repo named JSC30, include README.md and .gitignore
- Locally make a directory for your labs, put the JSC370-lab-02.qmd in the lab directory and push to GitHub
- Manually edit .gitignore to have GitHub ignore MS Word .docx files
- Push all changes
