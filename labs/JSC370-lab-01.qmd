...
- (Next week) Commit and push your work to GitHub Classroom.


## What you will submit

- This completed `.qmd` file
...
(If python3 doesn’t work, try python --version.) Paste the output, but the chunk above should do it for you if installed correctly.
...
Open the HTML in your browser to confirm it looks correct.